...
function p12() {
    ...
    echo "p12 $1 ..."
    openssl pkcs12 -export -out $newPath.p12 -name $alias -in $path.pem -inkey $path-key.pem -passin pass:$PASSWORD -passout pass:$PASSWORD
}
...
p12 ./custom-ca/governance/cacert governance governanceca
p12 ./custom-ca/governance/uicert ui uicert
p12 ./custom-ca/business/cacert business businessca
